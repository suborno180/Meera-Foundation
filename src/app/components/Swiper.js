...
import { Swiper, SwiperSlide } from "swiper/react"; // Import Swiper from swiper/react
import Image from "next/image";
import "swiper/css";
import "swiper/css/pagination";
import "swiper/css/navigation";
import { Autoplay, Pagination, Navigation } from "swiper"; // Import Swiper modules
  ...
  return (
    <>
      ...
      >
        ...
        <SwiperSlide className="h-[500px] w-screen max-md:h-[240px] ">
          <Image src={'/frontslide5'} fill={true} alt="slideimg5" />
        </SwiperSlide>
        <SwiperSlide className="h-[500px] w-screen max-md:h-[240px] ">
