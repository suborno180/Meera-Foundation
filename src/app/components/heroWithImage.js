        ...
        <>
            ...
            <div className="relative flex flex-col items-center mx-auto lg:flex-row-reverse lg:max-w-5xl lg:mt-12 xl:max-w-6xl max-lg:mt-16">
                ...
                <div
                    ...
                    className="w-full h-64 lg:w-1/2 lg:h-[600px] relative"
                >
                    <Image
                        src={"/savenature.jpg"}
                        layout="fill"
                ...
                <div
                    data-aos="fade-right"
                    data-aos-duration="1500"
                    className="max-w-lg bg-white md:max-w-2xl md:z-10 md:shadow-lg md:absolute md:top-0 md:mt-48 lg:w-3/5 lg:left-0 lg:mt-40 lg:ml-20 xl:mt-24 xl:ml-12"
                >
                    {/* <!-- Text Wrapper --> */}
