            ...
            <div className="col-span-4 sm:col-span-9  mx-auto">
                <div className="bg-white shadow  p-6 m-auto">
                    ...
                    <div className="mb-6">
                        ...
                        For further inquiries please dont hesitate to contact us at <Link href={"/contactus"} className="font-bold text-[19px] text-[#27AB61]">Contact Us</Link>
                        </p>
                    </div>
...
export function generateMetadata({ params }) {
    ...
    return {
      title: "FAQs",
      description: "Meera Foundation's FAQ page tackles your questions about poverty, education, healthcare, and how we can help. Explore our resources and gain clarity on how you can contribute to building a stronger community."
    }
  }
